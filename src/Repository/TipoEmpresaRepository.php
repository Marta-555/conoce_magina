...
/**
 * @extends ServiceEntityRepository<TipoEmpresa>
 *
...
class TipoEmpresaRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TipoEmpresa $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TipoEmpresa $entity, bool $flush = true): void
    {
