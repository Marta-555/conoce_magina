...
class Restaurante
{
    ...
    #[ORM\ManyToOne(targetEntity: Categoria::class, inversedBy: 'restaurantes')]
    #[ORM\JoinColumn(nullable: false)]
    private $categoria;

    #[ORM\ManyToOne(targetEntity: Municipio::class, inversedBy: 'restaurantes')]
    #[ORM\JoinColumn(nullable: false)]
    private $municipio;
    ...
    public function getImageUrl(): ?string
    {
        ...
        return sprintf('images/uploads/%s', $this->image);
    }
